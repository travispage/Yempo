...
if (!current_user_can($cb_user_role_permission)) {
   ...
   <script type="text/javascript">
      ...
      jQuery("#ux_clr_font_color").blur(function () {
         jQuery("#clr_font_color").slideUp()
      });
      jQuery("#ux_clr_text_color_input_field").blur(function () {
         jQuery("#clr_text_color").slideUp()
      });
      jQuery("#ux_clr_border_color_input_field").blur(function () {
         jQuery("#clr_border_color").slideUp()
      });
      jQuery("#ux_clr_bg_color_input_field").blur(function () {
         jQuery("#clr_bg_color").slideUp()
      });
      jQuery("#ux_clr_bg_color_submit_button").blur(function () {
         jQuery("#clr_bg_color_submit_button").slideUp()
      });
      jQuery("#ux_clr_hover_bg_color_submit_button").blur(function () {
         jQuery("#clr_hover_bg_color_submit_button").slideUp()
      });
      jQuery("#ux_clr_text_color_submit_button").blur(function () {
         jQuery("#clr_text_color_submit_button").slideUp()
      });
      jQuery("#ux_clr_border_color_submit_button").blur(function () {
         jQuery("#clr_border_color_submit_button").slideUp()
      });
      jQuery("#ux_clr_bg_color_success_msg").blur(function () {
         jQuery("#clr_bg_color_success_msg").slideUp()
      });
      jQuery("#ux_clr_border_color_success_msg").blur(function () {
         jQuery("#clr_border_color_success_msg").slideUp()
      });
      jQuery("#ux_clr_text_color_success_msg").blur(function () {
         jQuery("#clr_text_color_success_msg").slideUp()
      });
      jQuery("#ux_clr_bg_color_error_msg").blur(function () {
         jQuery("#clr_bg_color_error_msg").slideUp()
      });
      jQuery("#ux_clr_border_color_error_msg").blur(function () {
         jQuery("#clr_border_color_error_msg").slideUp()
      });
      jQuery("#ux_clr_text_color_error_msg").blur(function () {
         jQuery("#clr_text_color_error_msg").slideUp()
      });
