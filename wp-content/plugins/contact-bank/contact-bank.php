...
if (!defined("CONTACT_BK_PLUGIN_DIR"))
   define("CONTACT_BK_PLUGIN_DIR", plugin_dir_path(__FILE__));
if (!defined("CONTACT_BK_PLUGIN_DIRNAME"))
   define("CONTACT_BK_PLUGIN_DIRNAME", plugin_basename(dirname(__FILE__)));
if (!defined("CONTACT_BK"))
   define("CONTACT_BK", "contact-bank/contact-bank.php");
if (!defined("CONTACT_BK_PLUGIN_BASENAME"))
   define("CONTACT_BK_PLUGIN_BASENAME", plugin_basename(__FILE__));
...
class Contact_Bank_Widget extends WP_Widget {
   ...
   function widget($args, $instance) {
      ...
      $form_data = $wpdb->get_var
          ...
          $wpdb->prepare
              (
              "SELECT count(*) FROM " . contact_bank_contact_form() . " WHERE form_id = %d", $instance["form_id"]
          )
      );
