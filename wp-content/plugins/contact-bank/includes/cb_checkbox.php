...
if (!current_user_can($cb_user_role_permission)) {
   ...
   $control_id = $wpdb->get_var
       ...
       $wpdb->prepare
           (
           "SELECT control_id FROM " . create_control_Table() . " where form_id= %d and field_id = %d and column_dynamicId = %d", $form_id, $field_type, $dynamicId
       )
   );
   if (count($control_id) != 0) {
      $form_data = $wpdb->get_results
          ...
          $wpdb->prepare
              (
              "SELECT * FROM " . contact_bank_dynamic_settings_form() . " where dynamicId= %d", $control_id
          )
      );
         ...
         <div class="layout-span12">
            <div class="widget-layout">
               <div class="widget-layout-title">
                  <h4><?php _e("Check Boxes", "contact-bank"); ?></h4>
               </div>
               <div class="widget-layout-body">
                  ...
                  <div class="layout-control-group">
                     ...
                     <div class="layout-controls">
                        <input type="text" class="layout-span9" id="chk_options_<?php echo $dynamicId; ?>" placeholder="<?php _e("Enter Options", "contact-bank"); ?>" name="chk_options_<?php echo $dynamicId; ?>" />
                        <input  value="<?php _e("Add", "contact-bank"); ?>" type="button" style="margin-left:10px;" class="btn btn-info layout-span2" id="chk_options_button_<?php echo $dynamicId; ?>" onclick="add_chk_options(<?php echo $dynamicId; ?>);"  name="chk_options_button_<?php echo $dynamicId; ?>" />
                     </div>
                  </div>
                  <?php
                  if (isset($form_settings[$dynamicId]["cb_checkbox_option_id"]) && isset($form_settings[$dynamicId]["cb_checkbox_option_val"])) {
                     ...
                     <div class="layout-control-group">
                        ...
                        <div class="layout-controls">
                           <input type="text" value="<?php echo isset($form_settings[$dynamicId]["cb_admin_label"]) ? $form_settings[$dynamicId]["cb_admin_label"] : _e("Untitled", "contact-bank"); ?>" class="layout-span12" id="ux_admin_label_<?php echo $dynamicId; ?>" class="layout-span12" id="ux_admin_label_<?php echo $dynamicId; ?>" placeholder="<?php _e("Enter Admin Label", "contact-bank"); ?>" name="ux_admin_label_<?php echo $dynamicId; ?>" />
                        </div>
                     </div>
                     <div class="layout-control-group">
