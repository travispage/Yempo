         ...
         <div class="layout-span12">
            <div class="widget-layout">
               <div class="widget-layout-title">
                  <h4><?php _e("Radio Buttons", "contact-bank"); ?></h4>
               </div>
                  ...
                  <div class="layout-control-group" >
                     ...
                     <div class="layout-controls">
                        <input type="text" class="layout-span9"
                               id="radio_options_<?php echo $dynamicId; ?>" placeholder="<?php _e("Enter Option", "contact-bank"); ?>"
                               name="radio_options_<?php echo $dynamicId; ?>" />
                        <input class="btn btn-info layout-span2" style="margin-left: 10px;"
                               value="<?php _e("Add", "contact-bank"); ?>" type="button"
                     ...
                     if (count($options_value) > 0) {
                        ...
                        <div class="layout-control-group" style="overflow: hidden;max-height: 110px;" id="bind_dropdown_<?php echo $dynamicId; ?>">
                           ...
                           <div class="layout-controls">
                              ...
                              <input class="btn btn-info layout-span2" style="margin-left:10px;"  value="<?php _e("Delete", "contact-bank"); ?>" type="button" id="ddl_options_btn_del_<?php echo $dynamicId; ?>" onclick="delete_rdl_options(<?php echo $dynamicId; ?>);"  name="ddl_options_btn_del_<?php echo $dynamicId; ?>" />
                           </div>
                        </div>
                        <?php
                     }
