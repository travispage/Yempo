		...
		<ul class="comments-custom unstyled"><?php
			...
			<div class="clear"></div>
				<div class="comments-custom_txt">
					...
					<a href="<?php echo get_comment_link( $comment->comment_ID ); ?>" class="btn1" title="<?php _e('Go to this comment', CHERRY_PLUGIN_DOMAIN); ?>"><?php echo strip_tags(substr(apply_filters('get_comment_text', $comment->comment_content), 0, $comment_len)); if (strlen($comment->comment_content) > $comment_len) echo '...';?></a>
				</div>
			</li>
		<?php
			endforeach; endif;?>
