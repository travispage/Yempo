...
// ---------------------------------------------------------
			...
			$options['google_mixed_3'] = array(
								'id' => 'google_mixed_3',
								'std' => array( 'size' => '14px', 'lineheight' => '23px', 'face' => 'Arial, Helvetica, sans-serif', 'style' => 'normal', 'character'  => 'latin', 'color' => '#bab9b9'));

			$options['h1_heading'] = array(
								'id' => 'h1_heading',
								'std' => array( 'size' => '24px', 'lineheight' => '20px', 'face' => 'Open Sans', 'style' => 'normal', 'character'  => 'latin', 'color' => '#bab9b9'));

			$options['h2_heading'] = array(
								'id' => 'h2_heading',
								'std' => array( 'size' => '40px', 'lineheight' => '40px', 'face' => 'Open Sans', 'style' => 'normal', 'character'  => 'latin', 'color' => '#99bf38'));

			$options['h3_heading'] = array(
								'id' => 'h3_heading',
								'std' => array( 'size' => '20px', 'lineheight' => '25px', 'face' => 'Open Sans', 'style' => 'normal', 'character'  => 'latin', 'color' => '#2b3a42'));

			$options['h4_heading'] = array(
								'id' => 'h4_heading',
								'std' => array( 'size' => '20px', 'lineheight' => '24px', 'face' => 'Open Sans', 'style' => 'normal', 'character'  => 'latin', 'color' => '#99bf38'));

			$options['h5_heading'] = array(
								'id' => 'h5_heading',
								'std' => array( 'size' => '15px', 'lineheight' => '18px', 'face' => 'Open Sans', 'style' => 'normal', 'character'  => 'latin', 'color' => '#2b3a42'));
...
// ---------------------------------------------------------
			...
			$options['logo_typography'] = array(
								'id' => 'logo_typography',
								'std' => array( 'size' => '76px', 'lineheight' => '76px', 'face' => 'Open Sans', 'style' => 'normal', 'character'  => 'latin', 'color' => '#2b3a42'));
...
// ---------------------------------------------------------
			...
			$options['menu_typography'] = array(
								'id' => 'menu_typography',
								'std' => array( 'size' => '14px', 'lineheight' => '16px', 'face' => 'Open Sans', 'style' => 'bold', 'character'  => 'latin', 'color' => '#3e454c'));
...
// ---------------------------------------------------------
			...
			$options['folio_button_text'] = array(
								...
								"std" => __('More Info', CURRENT_THEME),
								);
// ---------------------------------------------------------
// Parallax
// ---------------------------------------------------------
...
// ---------------------------------------------------------
			...
			$options['footer_menu_typography'] = array(
								...
								'std' => array( 'size' => '12px', 'lineheight' => '18px', 'face' => 'Arial, Helvetica, sans-serif', 'style' => 'normal', 'character'  => 'latin', 'color' => '#708997'));

			$options[] = array( 
			    "name" => "Title Footer Menu",
			    "type" => "heading"
			);
			$options['title_footer'] = array( 
			 "name" => 'Title Footer',
		     "desc" => '',
		     "id" => "title_footer",
		     "std" => __( 'Navigation', CURRENT_THEME ),
		     "type" => "text");
