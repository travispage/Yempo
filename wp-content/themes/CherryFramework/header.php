...
<head>
	<meta name="msvalidate.01" content="5962F91357D067D8753E6DEAFD2BE0A9" />
	...
	<link rel="stylesheet" type="text/css" media="all" href="<?php echo PARENT_URL; ?>/css/animate.css" />
	<?php
	...
	<!--[if gte IE 9]><!-->
		...
		<script type="text/javascript">
			jQuery(function(){
                ...
                $('.menu-item-object-page').addClass('animated bounceIn');
                
            document.getElementById('no_click_link').onclick = function() {
              document.getElementById('no_click_link').disabled = true;
            };
...
<body <?php body_class(); ?>>
    <style>
        .slider_caption .btn-primary:before {
            color: #fff !important;
            background:#cc1c27 !important;
        }
        
        .extra-wrap .btn-primary:before {
            color: #fff !important;
            background:#cc1c27 !important;
        }
        ...
        .nav .sf-menu .sub-menu:after {
            background:url(./images/arr1_menu1.png) no-repeat 50% 0 ;
        }
    </style>
	...
	<div id="motopress-main" class="main-holder">
		...
		<header class="motopress-wrapper header">
			<div class="container">
				<div class="row">
					<div class="<?php echo cherry_get_layout_class( 'full_width_content' ); ?>" data-motopress-wrapper-file="wrapper/wrapper-header.php" data-motopress-wrapper-type="header" data-motopress-id="<?php echo uniqid() ?>">						<?php get_template_part('wrapper/wrapper-header'); ?>
					</div>
				</div>
			</div>
		</header>